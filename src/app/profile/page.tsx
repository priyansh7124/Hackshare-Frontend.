...
const Profile = () => {
  ...
  return (
    <DefaultLayout>
      {show && <UpdateProfilePic setShow={setShow} type={type} />}

      <div className="mx-auto max-w-242.5">
        <Breadcrumb pageName="Profile" />

        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative h-35  overflow-y-hidden md:h-65">
            <Image
              src={
                authContext?.user?.coverPicture || "/images/cover/cover-01.png"
              }
              alt="profile cover"
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative   mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative rounded-full drop-shadow-2">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 z-999 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
                >
                  <svg
                    className="fill-current"
                    width="14"
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">{authContext?.user?.bio}</p>
              </div>
              ...
              <div className="mt-6.5">
                ...
                <div className="flex items-center justify-center gap-3.5">
                  <Link
                    href={authContext?.user?.socials?.facebook || "#"}
                    target="_blank"
                  ...
                  <Link
                    href={authContext?.user?.socials?.linkedin || "#"}
                    target="_blank"
                    className="hover:text-primary"
                    aria-label="social-icon"
                  >
                  ...
                  <Link
                    href={authContext?.user?.socials?.behance || "#"}
                    target="_blank"
                    className="hover:text-primary"
                    aria-label="social-icon"
                  >
                  ...
                  <Link
                    href={authContext?.user?.socials?.github || "#"}
                    target="_blank"
                    className="hover:text-primary"
                    aria-label="social-icon"
                  >
